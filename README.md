...
class SPAM:
    ...
    def error_print(self, symbol, text):
        return f"""{text}{Col.reset} {Col.Symbol(symbol, self.red, self.blue)}"""
    def success_print(self, symbol, text):
         return f"""{text}{Col.reset} {Col.Symbol(symbol, self.green, self.blue)}"""
    def color_print(self, symbol, text):
        return f"""{Col.Symbol(symbol, self.lblue, self.blue)} {self.red}{text}{Col.reset}"""
    def format_input(self, symbol, text):
        return f"""{text}{Col.reset}"""
    def banner(self):
...
╚════╝╚════╝╚═════╝\n
    ...
    def send_otp(self):
        ...
        try:
            ...
            if 'Thành công success ' in response:
                print(self.success_print("✓",f" {response}"))
            else:
                print(self.error_print("X",f" "+response))
        except:
            print(self.error_print("X",f" BAD REQUESTS LIMIT!"))
    def send_code(self):
        json_data = {
                'user': self.phone,
        ...
        try:
            ...
            print(self.success_print("X",f""+response))
        except:
            print(self.error_print("X",f"BAD REQUESTS LIMIT!"))
    def Gbay(self):
        json_data = {
        ...
        try:
            ...
            print(self.success_print("✓",f"Thành công success "))
        except:
            print(self.error_print("X",f"Thất bại error"))
    ...
    def vntrip(self):
        try:
            ...
            print(self.success_print("✓",f" Thất bại error "))
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.color_print("?","NHẬP SỐ ĐIỆN THOẠI MUỐN SPAM: "))
            if self.phone != '0975682796':
                if len(self.phone) == 10:
                    break
                print(self.format_print("ERROR", "NHẬP LẠI SỐ ĐIỆN THOẠI!"))
            if self.phone == '0975682796':
                print(self.format_print("!", "LÀM ƠN ĐỪNG SPAM SỐ ĐIỆN THOẠI LAM TUAN :))"))
            time.sleep(3)
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(3)
        sys.exit('\n'+SPAM().format_print('', 'Copyright by Charles:)'))
